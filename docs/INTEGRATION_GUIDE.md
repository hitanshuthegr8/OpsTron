...
3. **Copy the workflow file** from `docs/OpsTronicic.yml` into your repo at `.github/workflows/OpsTronicic.yml`
...
curl -O https://raw.githubusercontent.com/hitanshuthegr8/OpsTronicic/main/agent/OpsTronic_forwarder.py
...
|---|---|---|  
| `OPSTRON_BACKEND_URL` | ✅ | URL of your OpsTronic server + `/agent/logs/ingest` |
