    ...
    <div className="space-y-5">
      ...
      <div className="space-y-1.5">
        ...
        <Input
          ...
          placeholder="https://OpsTronicic.onrender.com  (leave blank to use default)"
        />
...
function StepDocker({ apiKey }: { apiKey: string }) {
  ...
  # Label any container you want OpsTronic to watch:
  your-app:
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          Then opt containers in: <code className="rounded bg-muted px-1 py-0.5">docker run --label OpsTronic.monitor=true your-app</code>
        </p>
      </div>
